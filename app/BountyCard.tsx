...
export default function BountyCard({ bounty }: Props) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl mb-8 flex gap-5 items-center"
      style={{
    ...
    >
      ...
      >
        {[30, 55, 80, 105, 130, 155].map((r) => (
          <circle key={r} cx="192" cy="40" r={r} fill="none"
      ...
      <div className="relative flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-[9px] font-black uppercase tracking-[0.18em] px-2.5 py-0.5 rounded-full"
            style={{
