  ...
  if (!session?.user?.email) {
    return (
      <AnimatedAuthBackground>
        <img src="/brand/sei-logo.png" alt="SEI" style={{ height: 48, filter: "brightness(0) invert(1)" }} className="mb-6" />
      ...
      <header className="relative bg-[#2D1B4E] overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 md:px-8 py-5 flex items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-3 md:gap-4 shrink-0">
            <img src="/brand/sei-logo.png" alt="SEI" style={{ height: 28, filter: "brightness(0) invert(1)" }} />
